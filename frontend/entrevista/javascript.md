...
- [WeakMap/WeakSet](#weakmapweakset) _(common gap)_
...
- [Functions & Scopes](#functions--scopes)
  ...
  - [Recursion](#recursion) _(e.g., deep object cloning)_
- [OOP & Prototypes](#oop--prototypes)
  - [Prototypal Inheritance](#prototypal-inheritance)
  - [ES6 Classes](#es6-classes)
  - [Inheritance](#inheritance)
  - [Singleton Pattern](#singleton-pattern) _(often missed)_
- [Data Structures](#data-structures)
  - [Array Methods](#array-methods) _(map, reduce, filter, sort)_
...
function safeHTML(strings, ...values) {
  ...
  return strings.reduce(
    (a, s, i) => a + s + (values[i] ? escape(values[i]) : ""),
    "",
  );
}
...
**`===` (Strict Equality)**: Compares **value AND type**. No type coercion. **Always prefer this.**

**`==` (Loose/Abstract Equality)**: Compares **value only**. Performs type coercion.
...
```javascript
// 1. null and undefined are only equal to each other
null == undefined     // true
null == 0             // false
undefined == false    // false

// 2. Number vs String → String becomes Number
42 == '42'           // true ('42' → 42)

// 3. Boolean vs Anything → Boolean becomes Number first
true == 1            // true (true → 1)
true == 2            // false (true → 1, 1 != 2)
false == 0           // true (false → 0)
true == 'true'       // false (true → 1, 'true' → NaN)

// 4. Object vs Primitive → Object calls valueOf() or toString()
...
```javascript
// ALWAYS use === except for null/undefined check:
if (value == null) {
...
**What happens when called with `new`:**
...
// 4. Return 'this' (unless you explicitly return an object)
// return this;
```
